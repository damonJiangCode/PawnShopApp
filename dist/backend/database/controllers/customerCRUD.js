...
exports.deleteCustomer = exports.updateCustomer = exports.findCustomer = exports.addCustomer = exports.searchCustomer = void 0;
const db_1 = require("../db");
// search customers
const searchCustomer = async (firstName, lastName) => {
...
const updateCustomer = async (id, customerData) => {
    const client = await (0, db_1.connect)();
    const { firstName, lastName, middleName, dateOfBirth, gender, address, city, province, country, postalCode, heightCm, heightFt, weightKg, weightLb, notes, pictureUrl, } = customerData;
    const query = `
    UPDATE customer 
