...
interface ClientActionsLayoutProps {
  actions: ClientActionConfig[];
}

const ClientActionsLayout: React.FC<ClientActionsLayoutProps> = ({
  actions,
}) => {
  return (
    <Box
...
export default ClientActionsLayout;
