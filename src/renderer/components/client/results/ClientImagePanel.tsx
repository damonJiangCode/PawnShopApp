...
import ClientFormDialog from "../form/ClientFormDialog";

interface ClientImagePanelProps {
  client: Client | null;
  onClientCreated?: (client: Client) => void;
  onClientUpdated?: (client: Client) => void;
}

const ClientImagePanel: React.FC<ClientImagePanelProps> = ({
  client,
  onClientCreated,
  onClientUpdated,
}) => {
...
export default ClientImagePanel;
